  ...
  return (
    <Router>
      <Switch>
        ...
        <Route path="/product" component={Product} /> {/* 产品页（具体商品展示）*/}
        ...
        <Route path="/ordermanagement" component={OrderManagement} /> {/* 订单管理页*/}
        <Route path="/productmanagement" component={ProductManagement} /> {/* 产品管理页*/}
        <Route path="/categorymanagement" component={CategoryManagement} /> {/* 订单更新页*/}
